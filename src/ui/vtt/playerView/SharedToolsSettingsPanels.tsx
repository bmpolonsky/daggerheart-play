...
function initialPlayerRoomId(): string {
  ...
  return parsePlayerSessionLocation(window.location.pathname, inferBasePathFromWorkspacePath(window.location.pathname), window.location.search, window.location.hash)?.roomId ?? '';
}
