...
export const REST_RULES: Record<RestType, {
  ...
  short: {
    ...
    fearFormula: 'GM получает 1d4 Страха.',
    moves: [
      'Исцелить HP: 1d4 + ранг',
      'Очистить Стресс: 1d4 + ранг',
      'Починить Броню: 1d4 + ранг',
      'Подготовить карты / получить Надежду'
    ]
  },
  long: {
    title: 'Продолжительный отдых',
    description: 'Каждый персонаж выбирает два хода отдыха; один и тот же ход можно выбрать дважды.',
    fearFormula: 'GM получает 1d4 + количество персонажей Страха и может продвинуть долгосрочный отсчёт.',
    moves: [
      'Очистить все HP',
      'Очистить весь Стресс',
      'Починить всю Броню',
      'Подготовить карты / получить Надежду',
